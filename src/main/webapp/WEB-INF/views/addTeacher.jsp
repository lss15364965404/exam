	...
	<form class="layui-form">
	  <div class="layui-form-item">
	    ...
	    <div class="layui-input-block">
	      <input name="teacher_name" lay-verify="title" autocomplete="off" placeholder="姓名" class="layui-input" type="text">
	    </div>
	  </div>
	  <div class="layui-form-item">
	    <label class="layui-form-label">教师用户名</label>
	    <div class="layui-input-block">
		...
		layui.use(['form', 'layedit', 'laydate'], function(){
		  ...
		  form.on('submit(demo1)', function(data){
        	...
        	console.log(a);
           	...
           	$.ajax({
            	url:'${pageContext.request.contextPath}/addTU',
            	type:"POST",
            	data:{'data':a},
