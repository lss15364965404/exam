...
<body>
	<blockquote class="layui-elem-quote" style="margin-top: 20px;margin-left: 10px;">我出的题</blockquote>
<div class="layui-tab layui-tab-brief" lay-filter="rightTab">
    ...
    <button class="layui-btn layui-btn-normal" id="addQuestion" style="position: absolute;right: 100px;top: 130px;">出题</button>
...
<script>
    ...
    layui.use(['element','layer','form','table'],function(){
        ...
        $("#addQuestion").click(function(){
            layer.open({
                type: 2,
                content: 'addQuestion',//此处后期要改为地址映射
                maxmin: true,
                title:'出题',
                area: ['1000px', '450px'],
